<div class="card leaves">
	...
	<div class="card-body">
			...
			<div class="card-body">
				<form id="filter-form" class="row g-3 align-items-center">
					<div class="col-auto">
						...
						<input type="text" class="form-control daterange_dokpen_putus" placeholder="Tanggal Putus"
							value="">
					</div>
					<div class="col-auto">
						...
						<select class="form-select dropdown-pmh-<?php echo time() ?> select2-picker">
							...
							<option value="2" <?php echo ($this->uri->segment(5) == '2') ? 'selected' : '' ?>>Belum
							</option>
						</select>
					</div>
					<div class="col-auto">
						...
						<select class="form-select dropdown-ppp-<?php echo time() ?> select2-picker">
							...
							<option value="2" <?php echo ($this->uri->segment(6) == '2') ? 'selected' : '' ?>>Belum
							</option>
						</select>
					</div>
					<div class="col-auto">
						...
						<select class="form-select dropdown-pjs-<?php echo time() ?> select2-picker">
							...
							<option value="2" <?php echo ($this->uri->segment(7) == '2') ? 'selected' : '' ?>>Belum
							</option>
						</select>
					</div>
					<div class="col-auto">
						...
						<select class="form-select dropdown-phs-<?php echo time() ?> select2-picker">
							...
							<option value="2" <?php echo ($this->uri->segment(8) == '2') ? 'selected' : '' ?>>Belum
							</option>
						</select>
					</div>
					<div class="col-auto">
						...
						<select class="form-select dropdown-bas-<?php echo time() ?> select2-picker">
							...
							<option value="2" <?php echo ($this->uri->segment(9) == '2') ? 'selected' : '' ?>>Belum
							</option>
						</select>
					</div>
				</form>
				...
				<div class="card border-0 shadow-sm h-100">
					<div class="card-body pb-3">
						...
						<div class="progress" style="height: 8px;">
							<div class="progress-bar bg-success summary-pmh-bar" role="progressbar" style="width: 0%;">
							</div>
						</div>
			...
			<div class="col mb-2" style="min-width: 160px;">
				<div class="card border-0 shadow-sm h-100">
					<div class="card-body pb-3">
						...
						<div class="progress" style="height: 8px;">
							<div class="progress-bar bg-success summary-ppp-bar" role="progressbar" style="width: 0%;">
							</div>
						</div>
			...
			<div class="col mb-2" style="min-width: 160px;">
				<div class="card border-0 shadow-sm h-100">
					<div class="card-body pb-3">
						...
						<div class="progress" style="height: 8px;">
							<div class="progress-bar bg-success summary-pjs-bar" role="progressbar" style="width: 0%;">
							</div>
						</div>
			...
			<div class="col mb-2" style="min-width: 160px;">
				<div class="card border-0 shadow-sm h-100">
					<div class="card-body pb-3">
						...
						<div class="progress" style="height: 8px;">
							<div class="progress-bar bg-success summary-phs-bar" role="progressbar" style="width: 0%;">
							</div>
						</div>
			...
			<div class="col mb-2" style="min-width: 160px;">
				<div class="card border-0 shadow-sm h-100">
					<div class="card-body pb-3">
						...
						<div class="progress" style="height: 8px;">
							<div class="progress-bar bg-success summary-bas-bar" role="progressbar" style="width: 0%;">
							</div>
						</div>
			...
			<div class="col mb-2" style="min-width: 160px;">
				<div class="card border-0 shadow-sm h-100">
					<div class="card-body pb-3">
						...
						<div class="progress" style="height: 8px;">
							<div class="progress-bar bg-success summary-relaas-bar" role="progressbar"
								style="width: 0%;"></div>
						</div>
		...
		<div class="table-responsive">
			<table
				id="table-edoc-<?php echo $this->uri->segment(4) ?>-<?php echo $this->uri->segment(5) ?>-<?php echo $this->uri->segment(6) ?>-<?php echo $this->uri->segment(7) ?>-<?php echo $this->uri->segment(8) ?>-<?php echo $this->uri->segment(9) ?>"
				class="display"></table>
		</div>
	</div>
</div>
