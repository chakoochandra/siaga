...
function get_default_about_content($moduleType)
{
	$defaults = [
		...
		'relaas' => [
			'title' => 'Tentang Modul Kinerja Relaas',
			'description' => 'Modul ini menampilkan daftar prediksi relaas yang belum diunggah.',
			'features' => [
				'Tampilan data kinerja relaas per kecamatan',
				'Filter berdasarkan rentang tanggal',
				'Data perbandingan rentang waktu dan triwulan berjalan',
				'Statistik jumlah relaas, input/unggah, sisa, dan skor persentase',
				'Data dapat diklik untuk melihat detail relaas',
				'Visualisasi grafik untuk setiap periode'
			],
		...
		'kinerja_hakim' => [
			'title' => 'Tentang Modul Laporan Kegiatan Hakim (LIPA 6)',
			'description' => 'Modul ini menampilkan statistik dan rekapitulasi kegiatan hakim berdasarkan perkara yang diterima, diputus, dan sisa secara periodik menggunakan rentang tanggal.',
			'features' => [
				'Tampilan data kegiatan per hakim (hakim aktif)',
				'Filter berdasarkan rentang tanggal',
				'Filter berdasarkan jabatan hakim (Majelis / Hakim Tunggal)',
				'Kolom Diterima: Cerai Gugat (G), Cerai Talak (P), Gugat Sederhana (GS), dan Jumlah',
				'Kolom Putus: Cerai Gugat (G), Cerai Talak (P), Gugat Sederhana (GS), dan Jumlah',
				'Kolom Sisa: Cerai Gugat (G), Cerai Talak (P), Gugat Sederhana (GS), dan Jumlah',
				'Data dapat diklik untuk melihat daftar perkara sesuai kategori',
				'Total footer untuk setiap kolom'
			],
			'usage' => [
				'Gunakan filter rentang tanggal untuk memilih periode yang ingin ditampilkan',
				'Gunakan dropdown Jabatan Hakim untuk memfilter berdasarkan Majelis atau Hakim Tunggal',
				'Klik pada angka dalam tabel untuk melihat daftar perkara sesuai hakim dan kategori',
				'Gunakan scroll horizontal untuk melihat kolom-kolom yang tidak muat di layar',
				'Kolom G = Cerai Gugat (alur 15), P = Cerai Talak (alur 16), GS = Gugat Sederhana (alur 17)'
			],
			'notes' => [
				'LIPA 6 = Laporan Kegiatan Hakim',
				'Data hanya menampilkan hakim aktif',
				'Sisa dihitung dari perkara yang diterima namun belum diputus dalam periode',
				'Majelis = hakim dengan jabatan_hakim_id 1, Hakim Tunggal = jabatan_hakim_id 3'
			]
		],
		'kinerja_mediasi' => [
			'title' => 'Tentang Modul Kinerja Mediasi (LIPA 12)',
			'description' => 'Modul ini menampilkan statistik kinerja mediasi perkara berdasarkan bulan.',
			'features' => [
				'Tampilan data kinerja mediasi per bulan',
				'Filter berdasarkan tahun',
				'Sisa perkara dari bulan lalu',
				'Perkara diterima bulan ini',
				'Perkara yang memasuki mediasi',
				'Perkara berhasil (akta, sebagian, cabut)',
				'Perkara tidak berhasil dan gagal',
				'Perkara yang masih dalam proses mediasi',
			...
			'usage' => [
				...
				'Gunakan scroll horizontal untuk melihat kolom-kolom yang tidak muat di layar',
				'Kolom berhasil akta: hasil mediasi Y, bukan cabut',
				'Kolom berhasil sebagian: hasil mediasi S',
				'Kolom berhasil cabut: hasil mediasi Y, status_putusan_id = 7, dan cabut',
				'Kolom gagal: hasil mediasi D (semua jenis pengadilan)'
			]
		],
		'kinerja_durasiputus' => [
		...
		'kinerja_perlindungan' => [
			'title' => 'Tentang Modul Kinerja Perlindungan',
			'description' => 'Modul ini menampilkan kinerja perlindungan dalam menyelesaikan perkara perceraian (talak dan gugat) berdasarkan jenis putusan.',
			'features' => [
				'Nama Hakim: Nama lengkap hakim yang menangani perkara',
				'Talak Kabul: Jumlah perkara perceraian jenis talak yang diputus kabul (diterima)',
				'Talak Perlindungan: Jumlah perkara talak yang diputus kabul dan mengandung unsur perlindungan seperti mut\'ah, nafkah, harta bersama, damai, pengasuhan, hak asuh, dll',
				'Talak Nafkah Anak: Jumlah perkara talak yang diputus kabul dan mengandung nafkah anak (dengan catatan khusus untuk anak)',
				'Talak Nafkah Istri: Jumlah perkara talak yang diputus kabul dan mengandung nafkah istri seperti mut\'ah, iddah, harta bersama, dll',
				'Talak Nafkah Keduanya: Jumlah perkara talak yang diputus kabul dan mengandung nafkah untuk anak dan istri secara bersamaan',
				'Gugat Kabul: Jumlah perkara perceraian jenis gugat yang diputus kabul (diterima)',
				'Cabut Rukun: Jumlah perkara yang tidak diputus kabul (ditolak, gugur, rukun, dll)',
				'Persen Perlindungan: Persentase dari kasus yang mengandung unsur perlindungan terhadap total kasus kabul'
			],
			'usage' => [
				'Gunakan filter rentang tanggal untuk memilih periode yang ingin ditampilkan',
				'Klik pada angka untuk melihat daftar perkara sesuai kriteria',
				'Gunakan scroll horizontal untuk melihat kolom-kolom yang tidak muat di layar'
			]
		],
		...
		'monitoring_putusecourt' => [
			'title' => 'Tentang Modul Monitoring TTE e-Court',
		...
		'monitoring_tundaan' => [
			'title' => 'Tentang Modul Monitoring Input Tundaan',
			'description' => 'Modul monitoring input tundaan berdasarkan jadwal sidang terakhir.',
			'features' => [
				'Monitoring jadwal sidang',
				'Data tundaan lengkap',
				'Informasi majelis dan panitera',
				'Status e-Court'
			],
			'usage' => [
				'Pantau jadwal sidang terakhir',
				'Lihat status input tundaan',
				'Kelola informasi perkara'
			],
			'notes' => [
				'Data berdasarkan jadwal sidang terakhir',
				'Hanya menampilkan perkara dengan ikrar_talak = T'
			]
		],
		'monitoring_prodeo' => [
			'title' => 'Tentang Modul Prodeo',
			'description' => 'Modul monitoring panggilan perkara prodeo.',
			'features' => [
			...
			'notes' => [
				'Prodeo = perkara untuk pihak yang tidak mampu'
			]
		],
		'monitoring_ghaib' => [
		...
		'monitoring_ac' => [
			...
			'description' => 'Modul monitoring akta cerai yang telah diterbitkan dari perkara cerai.',
			'features' => [
		...
		'monitoring_dokumen_penetapan' => [
			'title' => 'Tentang Modul Monitoring e-Doc',
			'description' => 'Modul monitoring ketersediaan e-Doc perkara berdasarkan tahun pendaftaran.',
			'features' => [
				'Monitoring dokumen PMH, PPP, PJS, dan PHS',
				'Filter berdasarkan tahun pendaftaran',
				'Data diambil dari database SIPP'
			],
			'usage' => [
				'Gunakan filter tahun pendaftaran untuk memilih periode data',
				'Lihat status ketersediaan masing-masing e-Doc',
				'Gunakan scroll horizontal untuk melihat kolom lainnya'
			],
			'notes' => [
				'PMH, PPP, PJS, dan PHS adalah jenis e-Doc',
				'Tahun default adalah 2026'
			]
		],
		'monitoring_pbt' => [
			'title' => 'Tentang Modul Monitoring PIP',
			'description' => 'Modul monitoring pemberitahuan isi putusan (PIP) untuk memonitor proses pengiriman putusan kepada pihak-pihak yang bersangkutan.',
			'features' => [
				'Monitoring PIP',
		...
		'rekapitulasi_cerai' => [
			...
			'description' => 'Modul data perkara cerai',
			'features' => [
				'Data cerai muda',
				'Dispensasi kawin',
				'Filter usia',
